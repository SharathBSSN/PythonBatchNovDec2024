#!/usr/bin/python
"""
Purpose: Writing csv to demonstrate quoting char

"""
import csv

with open("my_quote_char.csv", "w", newline="", encoding="utf-8") as gh:
    header_names = ("sno", "name", "language","quote_char")
...
#NOTE: csv.QUOTE_MINIMAL (default): Only fields containing special characters are quoted.

# sno|name|language|quote_char
# 1|english|Python|"|"
# 2|Russian|питон|"|"
# 3|Italian|Pitone|"|"
# 4|Japanese|パイソン|"|"
...
quotechar: 
    Defines the character used for quoting (default is ").
quoting: 
    Determines when quoting should occur. Options include:
    csv.QUOTE_MINIMAL (default): Only fields containing special characters are quoted.
