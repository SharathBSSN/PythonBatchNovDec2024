...
print("Assignment -1\n")
first = 10
while first > LIMIT_02:
    # print(f"{first  =}")
    second = 10
    while second > LIMIT_02:
        print(f"{first:02} * {second:02} = {first * second:03}",)    
        second -= 1        
    first -= 1
    print("=" * 15) 
...
print("Assignment -1\n")
first = 0
while first < LIMIT_01:
    first += 1
    # print(f"{first  =}")
    second = 0
    while second < LIMIT_01:
        second += 1       
        print(f"{second:02} * {first:02} = {second * first:03} |", end=" ")    
    print() 
